...
final focusRepoProvider = Provider((ref) => FocusRepository(ref.watch(apiClientProvider)));
...
class FocusRepository {
  ...
  Future<Map<String, dynamic>> complete(String id, {required int actualMinutes, int distractions = 0, bool aiReflection = false}) async {
  ...
  Future<void> cancel(String id) => _api.postJson('/focus/sessions/$id/cancel', body: {});
}
